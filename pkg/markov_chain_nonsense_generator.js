...
* @returns {string}
*/
export function generate_text(data, rule_length, result_length) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.generate_text(retptr, ptr0, len0, rule_length, result_length);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('markov_chain_nonsense_generator_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
